...
},{"../models/Meme":3,"backbone":17}],2:[function(require,module,exports){
var Backbone = require('backbone'),
...
},{"./router/router.js":5,"backbone":17,"jquery":19,"underscore":20}],3:[function(require,module,exports){
var Backbone = require('backbone');
...
module.exports = MemeNav = Backbone.Model.extend({
	defaults : {
		categories : ["funny","cats","pics","aww","earthporn","gifs","earthporn","WTF","fffffffuuuuuuuuuuuu","woahdude","adviceanimals","india"]
	}
})
},{"backbone":17}],5:[function(require,module,exports){
var Backbone = require('backbone'),
	$ 		 = require('jquery'),
	_ 	     = require('underscore');
...
},{"../views/MemeHomeLayoutView":13,"./routes":6,"backbone":17,"jquery":19,"underscore":20}],6:[function(require,module,exports){
var $ = require('jquery'),
	_ = require('underscore');
...
},{"../models/Meme":3,"../views/MemeLargeItemView":15,"jquery":19,"underscore":20}],7:[function(require,module,exports){
var _ = require('underscore');
module.exports = function(obj){
var __t,__p='',__j=Array.prototype.join,print=function(){__p+=__j.call(arguments,'');};
with(obj||{}){
__p+='<div class="memes-container clearfix"><h2>Trending <em>'+
((__t=( category))==null?'':__t)+
'</em> pics on the interwebs</h2></div><div class="more-fun"><button class="more-fun-button btn btn-lg">More fun :D</button></div>';
}
return __p;
};
...
var __t,__p='',__j=Array.prototype.join,print=function(){__p+=__j.call(arguments,'');};
with(obj||{}){
__p+='<div class="meme-home-layout row"></div>';
}
return __p;
};
...
var __t,__p='',__j=Array.prototype.join,print=function(){__p+=__j.call(arguments,'');};
with(obj||{}){
__p+='<div class="col-xs-12"><div class="meme-top"><h3><a class="meme-title" href="#memes/'+
((__t=( section))==null?'':__t)+
'/'+
((__t=( _id))==null?'':__t)+
'">'+
((__t=( title))==null?'':__t)+
'</a></h3></div><div class="meme-body"><a href="#memes/'+
((__t=( section))==null?'':__t)+
'/'+
((__t=( _id))==null?'':__t)+
'">';
  var arr = link.split('.'); arr[arr.length-2] += "l"; var img_url = arr.join('.'); 
__p+='<img class="meme-image" src="'+
((__t=( img_url))==null?'':__t)+
'"></a></div><div class="meme-bottom"><p>Something here</p></div></div>';
}
return __p;
};
...
var __t,__p='',__j=Array.prototype.join,print=function(){__p+=__j.call(arguments,'');};
with(obj||{}){
__p+='<div class="row"><div class="col-xs-12"><div class="meme-large-header row"><div class="col-xs-12"><h1>'+
((__t=( title))==null?'':__t)+
'</h1></div></div><div class="meme-large-body row"><div class="col-xs-12">';
...
'"><img src="'+
((__t=( link))==null?'':__t)+
'" class="meme-large-image"></a></div></div><div class="meme-large-footer row"><div class="col-xs-12">Score : '+
((__t=( score))==null?'':__t)+
'</div></div></div></div>';
}
return __p;
...
var __t,__p='',__j=Array.prototype.join,print=function(){__p+=__j.call(arguments,'');};
with(obj||{}){
__p+='<div class="row"><div class="col-xs-12"><h3 class="meme-nav-header">Choose the kind of <b>FUN!</b></h3><select name="category" class="meme-category-select">';
 for(var i=0,len=categories.length; i < len; ++i){ 
__p+='<option class="meme-category-option" value="'+
((__t=( categories[i]))==null?'':__t)+
'">'+
((__t=( categories[i]))==null?'':__t)+
'</option>';
} 
...
},{"../templates/MemeCollectionTemplate.jst":7,"./MemeItemView":14,"backbone":17,"jquery":19,"underscore":20}],13:[function(require,module,exports){
var Backbone = require('backbone'),
	$ 		 = require('jquery');
...
},{"../collections/MemeCollection":1,"../models/MemeNav":4,"../templates/MemeHomeLayoutTemplate.jst":8,"./MemeCollectionView":12,"./MemeNavView":16,"backbone":17,"jquery":19}],14:[function(require,module,exports){
var Backbone = require('backbone'),
	$ 		 = require('jquery');
...
},{"../templates/MemeItemTemplate.jst":9,"backbone":17,"jquery":19}],15:[function(require,module,exports){
var Backbone = require('backbone'),
	$ 		 = require('jquery');
...
},{"../templates/MemeLargeItemTemplate.jst":10,"backbone":17,"jquery":19}],16:[function(require,module,exports){
var Backbone = require('backbone'),
	$ 		 = require('jquery');
...
},{"../templates/MemeNavTemplate.jst":11,"backbone":17,"jquery":19}],17:[function(require,module,exports){
//     Backbone.js 1.1.2
